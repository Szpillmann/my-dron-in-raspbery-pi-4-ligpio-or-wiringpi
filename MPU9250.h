...
//                    yaw   *= 180.0f / PI; 
//                    yaw   -= 2.56; // Declination at CHILE it is 2.56 
//                    return yaw;
//                   break;
//            case getpitch:
//                    pitch = -asin(2.0f * (q[1] * q[3] - q[0] * q[2]));
//                    pitch *= 180.0f / PI;
//                    pitch   -= -0.1; // Declination at Nasik, California is 0 degrees 1 minutes, For pune it is 13.8
//                    return pitch;
//                  break;
//            case getroll:
//                    roll  = atan2(2.0f * (q[0] * q[1] + q[2] * q[3]), q[0] * q[0] - q[1] * q[1] - q[2] * q[2] + q[3] * q[3]);
//                    roll  *= 180.0f / PI;
//                    roll   -= -0.1; // Declination at Nasik, California is 0 degrees 1 minutes, For pune it is 13.8
//                    return roll;
//                  break;
//          }
//        }
